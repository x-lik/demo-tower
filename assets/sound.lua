...
assets_vcm("Sound\\Interface\\AutoCastButtonClick1.wav", "war3_AutoCastButtonClick1")
assets_vcm("Sound\\Interface\\CreepAggroWhat1.wav", "war3_CreepAggroWhat1")
assets_vcm("Sound\\Interface\\Error.wav", "war3_Error")
assets_vcm("Sound\\Interface\\GoodJob.wav", "war3_GoodJob")
